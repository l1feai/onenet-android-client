...
import io.onenet.client.databinding.ActivityMainBinding;
import io.onenet.client.tool.RouteChangeListener;
import io.onenet.client.tool.ServiceStateListener;
import io.onenet.client.tool.VPNService;
import io.onenet.client.ui.PreferenceUI;
import io.onenet.gomobile.android.ConnectionListener;
import io.onenet.gomobile.android.NetworkArray;
import io.onenet.gomobile.android.PeerInfoArray;
import io.onenet.gomobile.android.URLOpener;
...
public class MainActivity extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener, ServiceAccessor, StateListenerRegistry {
    ...
    private final static String LOGTAG = "ONETMainActivity";
    ...
    private void openDocs() {
        String url = "https://docs.l1fe.network";
    ...
    private void removeToolbarShadow() {
        ...
        binding.appBarMain.toolbar.setBackground(new ColorDrawable(ContextCompat.getColor(this, R.color.onet_bg_home)));
    }
    ...
    private void resetToolbar() {
        ...
        binding.appBarMain.toolbar.setElevation(0);
        binding.appBarMain.toolbar.setBackground(new ColorDrawable(ContextCompat.getColor(this, R.color.onet_bg)));
    }
