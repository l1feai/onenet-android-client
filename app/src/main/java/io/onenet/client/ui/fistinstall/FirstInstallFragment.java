package io.onenet.client.ui.fistinstall;
...
import io.onenet.client.databinding.FragmentFirstinstallBinding;
import io.onenet.client.ui.server.ChangeServerFragment;
        ...
        if (startIndex != -1) {
            ClickableSpan clickableSpan = new ClickableSpan() {
                ...
                public void updateDrawState(@NonNull TextPaint ds) {
                    ...
                    ds.setColor(ContextCompat.getColor(requireContext(), R.color.onet_orange));
                }
            };
