package io.onenet.client.ui.about;
...
import io.onenet.client.databinding.FragmentAboutBinding;
...
public class AboutFragment extends Fragment {
    ...
    public void onLicenseClick(View view) {
        Intent intent = new Intent(Intent.ACTION_VIEW, Uri.parse("https://l1fe.network/terms"));
        startActivity(intent);
    }

    public void onPrivacyClick(View view) {
        Intent intent = new Intent(Intent.ACTION_VIEW, Uri.parse("https://l1fe.network/privacy"));
        startActivity(intent);
    }
