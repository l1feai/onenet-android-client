...
import static io.onenet.client.ui.home.PeersAdapter.FilterStatus.ALL;
...
import io.onenet.client.databinding.ListItemPeerBinding;
...
public class PeersAdapter extends RecyclerView.Adapter<PeersAdapter.PeerViewHolder> {
    ...
    public PeerViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        io.onenet.client.databinding.ListItemPeerBinding binding = ListItemPeerBinding.inflate(LayoutInflater.from(parent.getContext()), parent, false);
