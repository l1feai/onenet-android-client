...
import io.onenet.client.tool.networks.ConcreteNetworkAvailabilityListener;
import io.onenet.client.tool.networks.NetworkChangeDetector;
...
public class VPNService extends android.net.VpnService {
    ...
    public static final String INTENT_ACTION_START = "io.onenet.client.intent.action.START_SERVICE";
