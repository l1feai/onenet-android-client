...
public class Preferences {
    ...
    public static String configFile(Context context){
       return context.getFilesDir().getPath() + "/onenetwork.cfg";
    }
    ...
    public Preferences(Context context) {
       sharedPref = context.getSharedPreferences("onenetwork", Context.MODE_PRIVATE);
    }
    ...
    public static String defaultServer() {
        return "https://api.vpn.l1fe.network";
    }
}
